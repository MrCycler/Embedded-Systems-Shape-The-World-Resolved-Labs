...
unsigned long n = 0;
while(buffer[n]!=0){UART_OutChar(buffer[n]);n++;	}
...
// as part of Lab 11 implement this function
	...
	unsigned char b =0;
  if(n>9999){
	while(i>=0){String[i] = '*';i--;}String[4]=0;		
	}
	else { 
		if (n/1000 == 0){String[0]=' ';}else{String[0]=n/1000 + 0x30;b=1;}
		n = n%1000;  
		if ((n/100 == 0)&&(b==0)){String[1]=' ';}else{String[1]=n/100 + 0x30;b=1;}
		n = n%100; 
		if ((n/10 == 0)&&(b==0)){String[2]=' ';}else{String[2]=n/10 + 0x30;}
		n = n%10;  
		String[3]=n + 0x30;    
    String[4]=0;		
}
